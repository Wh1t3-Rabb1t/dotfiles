...
# ---------------------------------------------------------------------------- #
print "Creating required directory tree / files...\n"
...
zf_ln -sfn "${SCRIPT_DIR}/eza" "${XDG_CONFIG_HOME}/eza"
zf_ln -sfn "${SCRIPT_DIR}/fd" "${XDG_CONFIG_HOME}/fd"
...
zf_ln -sfn "${SCRIPT_DIR}/ripgrep" "${XDG_CONFIG_HOME}/ripgrep"
