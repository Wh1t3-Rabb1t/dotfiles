...
-- Instead I feel like I'm confined to a prison
-- Proper life? It's nothing but a folly
-- No bonds I feel with the values deemed worthwhile
-- With fellow folk no solidarity
-- From daylight comes trifles, I choose exile
-- Moon, MOOOON! my dear friend, moon my dear friend in solidarity
-- My heart longs to bathe in thy radiant dew
-- But from where come thoughts making me estranged
-- From this life I have to bitterly chew?
-- In the crowd I'm alone, am I deranged?
-- Pious and wise alike sing barren tales
-- ...
-- Should I turn to magick if all else fails?
-- Should I turn to magick if all else fails?
-- SHOULD I TURN TO MAGICK IF ALL ELSE FAILS?
...
-- Well, every particle has an anti-particle, its mirror image,
-- its negative side. Maybe this universal mind resides in the
-- mirror image instead of in our universe as we wanted to believe.
-- ...
-- Maybe he's anti-god, bringing darkness instead of light.

------------------------------------------------------------------------------

-- Into the woods where the pagan oaks dance primal dances
-- and strange nightbirds gibber in the darkness.
